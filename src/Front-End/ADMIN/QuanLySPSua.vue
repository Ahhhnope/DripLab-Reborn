      ...
      <div class="popup">
        ...
        <div class="form-grid">
          ...
          <div class="form-group full">
            <label>Tên loại sữa</label>
            <input ref="inputName" v-model="form.tenLoai"
              placeholder="VD: Sữa tươi, Sữa oat..."
              @keyup.enter="requestSubmit" />
          </div>
          <div class="form-group full">
            <label>Giá (VNĐ)</label>
            <input v-model="form.gia" type="number" placeholder="VD: 15000"
              min="0" step="1" @keypress="blockDecimal" @keyup.enter="requestSubmit" />
          </div>
        </div>
...
function requestSubmit() {
  ...
  const label = isEditing.value ? 'Xác nhận cập nhật loại sữa?' : 'Xác nhận thêm loại sữa mới?';
