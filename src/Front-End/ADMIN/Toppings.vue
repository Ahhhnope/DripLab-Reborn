...
<!-- <script setup>
import useTopping from '../JS/Toppings.JS'
const { search, currentPage, PAGE_SIZE, filtered, totalPages, pageStart, pagedRows, ghostCount, fmtPrice, fmtDate, showForm, isEditing, inputName, form, openAdd, openEdit, submitForm, showConfirm, deleteTarget, openConfirm, doDelete, toastShow, toastMsg, toastType, showToast } = useTopping()
...
} = useIngredients('toppings', 'TP'); // Use 'toppings' category
