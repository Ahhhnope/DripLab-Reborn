    ...
    <div v-if="showPaymentPopup" class="popup-overlay">
      <div class="payment-popup">
        ...
        <template v-if="paymentMethod === 'cash'">
          ...
          <p
            v-if="customerMoney && (parseInt(customerMoney) || 0) < finalPrice"
            class="cash-insufficient"
          >
            ⚠ Số tiền khách đưa chưa đủ, còn thiếu {{ (finalPrice - (parseInt(customerMoney) || 0)).toLocaleString() }} VND
          </p>
