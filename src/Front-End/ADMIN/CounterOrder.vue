  ...
  <div class="counter-root">
      ...
      <div class="order-section">
        ...
        <div class="right-customer-block">
          ...
          <div class="right-table-row" style="margin-top:8px">
            ...
            <span class="right-table-val">{{ selectedTable ? String(selectedTable).padStart(2, '0') : 'Chưa chọn'
            }}</span>
          </div>
        </div>
        ...
        <div class="order-footer-block">
          <div class="discount-section">
            ...
            <div class="discount-bar">
              <select class="discount-select" disabled>
    ...
    <div v-if="showConfirmInfo" class="confirm-overlay">
      <div class="confirm-popup">
        ...
        <!-- Cảnh báo thông tin khách — box vàng nền vàng -->
    ...
    <div v-if="appStep === 'order'" class="counter-order">
      ...
      <div class="product-section">
        ...
        <div class="product-main">
          ...
          <!-- Grid sản phẩm — 4 cột, chỉ phần này scroll -->
          <div class="product-grid">
            <!-- Card logo DripLab → AdminEmployee -->
      ...
      <div class="order-section">
        ...
        <div class="right-customer-block">
          ...
          <div class="right-table-row" style="margin-top:6px">
            <span class="right-info-lbl">Đặt bàn:</span>
            <span class="right-table-val">{{ displayTableNum ? String(displayTableNum).padStart(2, '0') : 'Chưa có'
            }}</span>
          </div>
        </div>

        <!-- Sản phẩm mua — scroll dọc độc lập -->
        <div class="right-products-block">
          <p class="right-products-title">Sản Phẩm Mua</p>
      ...
      <div class="payment-popup">
        ...
        <template v-if="paymentMethod === 'cash'">
          ...
          <p v-if="customerMoney && (parseInt(customerMoney.replace(/\./g, '')) || 0) < finalPrice"
            ...
            ⚠ Số tiền khách đưa chưa đủ, còn thiếu {{ (finalPrice - (parseInt(customerMoney.replace(/\./g, '')) ||
              0)).toLocaleString() }}
            VND
          </p>
        ...
        <template v-else>
          ...
          <div v-else class="momo-body">
            ...
            <div class="payment-footer">
              ...
              <button class="btn-confirm momo-btn" @click="goToReview">Kiểm tra</button>
            </div>
          </div>
        </template>
      </div>
    ...
    <div v-if="showReviewPopup" class="popup-overlay">
      <div class="review-popup">
        ...
        <div class="review-row">
          ...
          <span class="review-val">{{ receiptData.tableNum ? String(receiptData.tableNum).padStart(2, '0') : 'Chưa có'
          }}</span>
        </div>
        <div class="review-row">
        ...
        <div class="success-body">
          ...
          <div class="success-receipt">
            ...
            <div class="success-row b">
              <span>Họ và tên</span>
              <span>{{ receiptData.customerName || receiptData.anonCode || 'Chưa có' }}</span>
            </div>
            <div class="success-row b">
              <span>Số điện thoại</span>
              <span>{{ receiptData.customerPhone || 'Chưa có' }}</span>
            </div>
            <div class="success-row b">
              <span>Đặt bàn</span>
              <span>{{ receiptData.tableNum ? String(receiptData.tableNum).padStart(2, '0') : 'Chưa có' }}</span>
            </div>
            ...
            <div class="success-row b">
              <span>Hình thức</span>
              <span>{{ paymentMethod === 'cash' ? 'Tiền mặt' : 'Ví MoMo' }}</span>
            </div>
            <div v-if="paymentMethod === 'momo'" class="success-row b">
              <span>Người nhận MoMo</span>
              <span>{{ momoName }}</span>
            </div>
            <div class="success-row b">
            ...
            <div v-if="receiptData.discountPercent > 0" class="success-row b">
              <span>Giá gốc</span>
              <span>{{ receiptData.originalPrice.toLocaleString() }} VNĐ</span>
            </div>
            <div v-if="receiptData.discountPercent > 0" class="success-row b">
              <span>Giảm giá</span>
