              ...
              <div class="lg:col-span-8 space-y-6">
                ...
                <div class="rounded-xl border border-stone-100 bg-stone-50/50 p-5">
                  ...
                  <div class="grid grid-cols-12 gap-y-2 gap-x-4">
                    ...
                    <div class="col-span-4 text-sm text-stone-400" v-if="invoice.receive_type === 'Online'">Địa chỉ
                    </div>
                    <div class="col-span-8 text-sm font-medium" v-if="invoice.receive_type === 'Online'">
                ...
                <div class="space-y-3">
                  ...
                  <div v-for="(item, i) in invoice.items" :key="i"
                    ...
                    <div v-if="item.sugar != null || item.ice != null" class="flex flex-wrap gap-1">
                      <span v-if="item.sugar != null" class="text-[11px] font-semibold px-2 py-0.5 rounded-full"
