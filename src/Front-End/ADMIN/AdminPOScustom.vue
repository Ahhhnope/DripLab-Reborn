  ...
  <div class="pos-wrapper">
    ...
    <section class="products">
      ...
      <div class="custom-grid">
        <!-- BEAN -->
        <div
          :class="['custom-card', { 'card-done': selected.bean }]"
          @click="openBean"
        >
    ...
    <div class="order-section">
      ...
      <div class="order-footer-block">
        ...
        <div class="right-action-btns right-action-btns--footer">
          <button class="right-mode-btn right-mode-btn--disabled" disabled>
            Hình thức
          </button>
          <button
          ...
          <button v-else class="right-pay-btn right-pay-btn--disabled" disabled>
            Thanh toán
          </button>
        </div>
      </div>
    ...
    <Teleport to="body">
      ...
      >
        <div class="popup-box">
          ...
          <div class="popup-options">
            ...
            >
              <div class="option-info">
                ...
                <span class="option-desc" v-if="b.description">{{
                  b.description
                }}</span>
              </div>
          ...
          <div class="popup-footer">
            <button class="popup-btn-cancel" @click="showBeanPopup = false">
              Quay lại
            </button>
          </div>
        </div>
      ...
      >
        <div class="popup-box">
          ...
          <div class="popup-footer">
            <button class="popup-btn-cancel" @click="showBasePopup = false">
              Quay lại
            </button>
          </div>
        </div>
      ...
      >
        <div class="popup-box">
          ...
          <div class="popup-footer">
            <button class="popup-btn-cancel" @click="showMilkPopup = false">
              Quay lại
            </button>
          </div>
        </div>
          ...
          <div class="popup-topping-grid">
            <button
              ...
              :class="[
                'popup-topping-card',
                {
                  'topping-card--selected': selected.toppings.some(
                    (s) => s.name === t.name,
                  ),
            ...
            >
              <span class="topping-card-name">{{ t.name }}</span>
              <span class="topping-card-price"
                >+{{ t.price.toLocaleString() }}đ</span
              >
              <span
                v-if="selected.toppings.some((s) => s.name === t.name)"
                class="topping-card-check"
                >✓</span
              >
            </button>
          </div>

          <div class="popup-footer popup-footer--split">
            <button class="popup-btn-cancel" @click="showToppingPopup = false">
              Quay lại
            </button>
        ...
        <div class="payment-popup">
          ...
          <div class="pay-customer-section">
            ...
            <div class="pay-customer-row">
              ...
              <div class="pay-field">
                ...
                />
                <span v-if="payPhoneError" class="pay-field-err">{{
                  payPhoneError
                }}</span>
              </div>
            </div>
            <p class="pay-hint">
              Nếu bỏ trống tên, đơn sẽ hiển thị mã khách ẩn danh
            </p>
          </div>
          ...
          <div class="note-section">
            ...
            <textarea
              class="note-textarea"
              :value="posOrderNote"
              @input="(e) => (posOrderNote = e.target.value)"
      ...
      <div v-if="showReviewPopup" class="popup-overlay">
        <div class="review-popup">
          ...
          <div class="review-row">
            ...
            <span class="review-val">{{
              receiptData.customerPhone || "Không Có Thông Tin"
            }}</span>
          </div>
          <div class="review-row">
            <span class="review-lbl">Thanh toán</span>
            <span class="review-val">{{
              paymentMethod === "cash" ? "💵 Tiền mặt" : "🟣 Ví MoMo"
            }}</span>
          </div>
          <div class="review-row">
            <span class="review-lbl">Ghi chú</span>
            <span class="review-val review-note-val">{{
              posOrderNote || "Không có ghi chú"
            }}</span>
          </div>
          ...
          <div class="payment-footer">
            ...
            <button
              class="btn-confirm"
              :class="{ 'momo-btn': paymentMethod === 'momo' }"
        ...
        <div class="success-popup">
          ...
          <div class="success-scroll-body">
            <div class="success-receipt">
              <div
                class="success-receipt-header"
                :class="{
                  'success-receipt-header--cash': paymentMethod === 'cash',
                }"
              >
                <img
                ...
                <span class="receipt-label"
                  >Biên lai
                  {{
                    paymentMethod === "cash" ? "thanh toán" : "chuyển tiền"
                  }}</span
                >
              </div>
              ...
              <div class="success-row b">
                <span>Ghi chú</span
                ><span class="receipt-note-val">{{
                  posOrderNote || "Không có"
                }}</span>
              </div>
              ...
              <div class="receipt-divider"></div>
              <div v-if="discountPercent > 0" class="success-row b">
                <span>Giá gốc</span
