...
.tk-icon {
  font-size: 2rem;
  filter: drop-shadow(0 2px 4px rgba(111, 78, 55, .3));
}
...
/* ── SỬA: bỏ Playfair, dùng Be Vietnam Pro bình thường ── */
.tk-card-value {
  font-family: 'Plus Jakarta Sans', sans-serif;
  font-size: 1.25rem;
  font-weight: 600;
...
.tk-btn-outline {
  border: 1.5px solid var(--coffee-mid);
  background: transparent;
  color: var(--coffee-mid);
}
