...
// ✅ Nhận thêm reason từ OrderDetailModal
function onSetStatus({ id, status, reason }) {
  patchOrder({ id, status, reason });
}
...
.notify-pop-leave-active { transition: opacity 160ms ease; }
.notify-pop-enter-from,
.notify-pop-leave-to     { opacity: 0; }
