<template>
  <div class="account-wrapper">
          ...
          <div class="ud-container">
            ...
            <div class="ud-header">
              <div class="ud-header__left">
                ...
                <span
                  :class="[
                    'ud-status-badge',
                    `ud-status-badge--${selectedOrder.status}`,
                  ]"
                >
            ...
            <div class="ud-body custom-scrollbar">
              ...
              >
                ...
                <div class="ud-steps">
                  <div
                    class="ud-steps__connector"
                    :style="{
                      '--progress': getProgressWidth(selectedOrder.status),
                    }"
                  ></div>
                  <div
                    ...
                    :class="[
                      'ud-step',
                      getStepClass(step, selectedOrder.status),
                    ]"
                  >
              ...
              <div
                v-if="
                  selectedOrder.status === 'failed' && selectedOrder.failReason
                "
              ...
              >
                ...
                <span>
                  <strong>Giao hàng không thành công</strong> — Lý do:
                ...
                <div class="ud-col-left">
                  ...
                  <section class="ud-section">
                    <div class="ud-section__header ud-section__header--between">
                      ...
                      <span class="ud-qty-badge"
                        >{{ selectedOrder.totalQty }} món</span
                      >
                    </div>
                ...
                <div class="ud-col-right">
                  ...
                  <div class="ud-payment-card">
                    ...
                    <div class="ud-payment-total">
                      <span>Tổng cộng</span>
                      <span class="ud-payment-total__amount">{{
                        selectedOrder.price
                      }}</span>
                    </div>
                  </div>
                  ...
                  <div class="ud-action-group">
                    <button
                      v-if="
                        ...
                        !isPointed(selectedOrder.id)
                      "
                      class="ud-btn ud-btn--receive"
                      @click="
                        closeModal();
                        triggerReceiveConfirm(selectedOrder);
                      "
                    >
                      <svg
                        width="15"
                    ...
                    <button class="ud-btn ud-btn--ghost" @click="closeModal">
                      Đóng
                    </button>
                  </div>
                </div>
        ...
        >
          <div class="ud-confirm-card">
            ...
            <div class="ud-confirm-actions">
              ...
              <button
                class="ud-confirm-btn ud-confirm-btn--primary"
                @click="doCancel"
              >
                Có, huỷ đơn
              </button>
    ...
    <Teleport to="body">
      <Transition name="confirm-pop">
        <div
          v-if="showFailedPopup"
          class="ud-confirm-backdrop"
          @click.self="dismissFailedPopup"
        >
          <div class="ud-confirm-card">
            <!-- Icon cảnh báo màu cam -->
            <div class="ud-confirm-icon ud-confirm-icon--warning">
              <span
                class="ud-confirm-icon__inner ud-confirm-icon__inner--warning"
              >
                <svg
                  width="26"
                  height="26"
            ...
            <p class="ud-confirm-desc">
              Đơn hàng <strong>{{ failedTarget?.name }}</strong> của bạn đã giao
              không thành công.
            </p>
            ...
            <div v-if="failedTarget?.failReason" class="ud-failed-reason-box">
              ...
              <span class="ud-failed-reason-text">{{
                failedTarget.failReason
              }}</span>
            </div>
...
function getVisibleSteps(status) {
  ...
  if (status === "failed") {
    return ALL_STEPS.filter((s) =>
      ["pending", "processing", "shipping", "failed"].includes(s.key),
    );
  }
  if (status === "cancelled") {
    return ALL_STEPS.filter((s) =>
