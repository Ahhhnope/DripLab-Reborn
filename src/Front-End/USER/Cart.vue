          ...
          <div class="modal-box">
            ...
            <div class="modal-body">
              ...
              <template v-if="paymentMethod !== 'MOMO'">
                <div class="modal-section">
                  ...
                  <!-- Thay phần modal-order-item để hiện giá chi tiết -->
                  <div
                    v-for="item in selectedItems"
                    :key="item.mergeKey"
                  ...
                  >
                    <div class="moi-info">
                      ...
                      <div class="moi-price-breakdown">
                        <span
                          >Đồ uống: {{ formatVND(item.drinkBasePrice) }}</span
                        >
                ...
                <div class="modal-section">
                  ...
                  <div class="payment-methods">
                    ...
                    >
                      ...
                      />
                      <span
                        class="momo-option-fallback"
                        style="display: none; font-size: 1.6rem"
                        >📱</span
                      >
                ...
                <div v-if="momoStep === 1" class="momo-body">
                  ...
                  >
                    ...
                    <input
                      ...
                      maxlength="10"
                    />
                    <span v-if="momoLoading" class="momo-status-icon spin"
                      >⟳</span
                    >
                    <span v-else-if="momoName" class="momo-status-icon green"
                      >✓</span
                    >
                    <span v-else-if="momoError" class="momo-status-icon red"
                      >✕</span
                    >
                  </div>
                ...
                <div v-else class="momo-body">
                  ...
                  <div class="momo-confirm-card">
                    ...
                    <div class="momo-confirm-row">
                      ...
                      <span class="momo-confirm-val bold pink">{{
                        formatVND(grandTotal)
                      }}</span>
                    </div>
                    <div class="momo-confirm-row">
                      <span class="momo-confirm-label">Nội dung</span>
                      <span class="momo-confirm-val"
                        >Cà Phê Nhà - Thanh toán đơn hàng</span
                      >
                    </div>
                  </div>
                </div>
            ...
            <div class="modal-footer">
              ...
              <template v-else-if="paymentMethod === 'MOMO' && momoStep === 1">
                <button
                  class="btn-place-order btn-momo"
                  :disabled="!momoName"
              ...
              <p class="modal-terms">
                Bằng cách nhấn xác nhận, bạn đồng ý với điều khoản dịch vụ của
                chúng tôi.
              </p>
            </div>
          </div>
      ...
      <transition name="fade">
        <div v-if="showSuccessModal" class="modal-overlay">
          <div class="success-modal">
            ...
            <p class="success-msg">
              Cảm ơn bạn đã tin tưởng Drip Lab! Chúng tôi sẽ xác nhận và giao
