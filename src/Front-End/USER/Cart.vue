          ...
          >
            ...
            <div class="card-body">
              ...
              <div v-if="item.isCustom" class="card-tags card-tags--custom">
                <span v-if="item.beanName" class="tag tag-custom">{{
                  item.beanName
                }}</span>
                <span v-if="item.baseName" class="tag tag-custom">{{
                  item.baseName
                }}</span>
                <span v-if="item.milkName" class="tag tag-custom">{{
                  item.milkName
                }}</span>
              </div>
      ...
      <aside>
        <div class="order-summary-box">
              ...
              >
                <div class="preview-item-inner">
                  ...
                  >
                    ...
                    <span class="preview-detail-price" v-if="tp.price > 0"
                      >+{{ formatVND(tp.price) }}</span
                    >
                    <span class="preview-detail-price free" v-else>+0 đ</span>
                  </div>
                  <!-- Đường / Đá -->
                  <div class="preview-badges">
                    <span class="preview-badge sugar"
          ...
          <button
            ...
            @click="goToCheckout"
          >
            <span>Tiến hành thanh toán</span><span>→</span>
          </button>
        </div>
      </aside>
    </main>
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                >
                  ...
                  <div v-if="item.sizeName" class="moi-detail-row">
                    ...
                    <span class="moi-detail-label"
                      >Size {{ item.sizeName }}</span
                    >
                    <span class="moi-detail-price" v-if="item.sizePrice > 0"
                      >+{{ formatVND(item.sizePrice) }}</span
                    >
                  ...
                  <div
                    v-for="(tp, i) in item.toppingDetails"
                    :key="i"
                    class="moi-detail-row"
                  >
                    <span class="moi-detail-icon">+</span>
                    <span class="moi-detail-label">{{ tp.name }}</span>
                    <span class="moi-detail-price" v-if="tp.price > 0"
                      >+{{ formatVND(tp.price) }}</span
                    >
                    <span class="moi-detail-price free" v-else>+0 đ</span>
                  </div>
              ...
              <div class="modal-section">
                ...
                <div class="coupon-center-wrapper">
                  ...
                  <div
                    v-if="couponMessage"
                    class="coupon-feedback-centered"
